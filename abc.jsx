  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        {/* Main Category */}
        <div>
          <label htmlFor="mainCategoryId" className="block font-medium mb-1">
            Main Category
          </label>
          <select
            id="mainCategoryId"
            ...
            onChange={handleChange}
            className={`w-full border rounded p-2 ${
              errors.mainCategoryId ? "border-red-500" : "border-gray-300"
            }`}
          >
          ...
          {errors.mainCategoryId && (
            <p className="text-red-600 text-sm mt-1">{errors.mainCategoryId}</p>
          )}
        </div>
      </div>
      {/* Sub Category & Reference Book */}
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label htmlFor="subCategoryId" className="block font-medium mb-1">
            Sub Category
          </label>
          <select
            id="subCategoryId"
          ...
          {errors.subCategoryId && (
            <p className="text-red-600 text-sm mt-1">{errors.subCategoryId}</p>
          )}
        </div>
        {/* Reference Book */}
        <div>
...
<div className="grid grid-cols-2 gap-4">
      ...
      <div className="flex items-center space-x-2">
        ...
        />
        <label
          htmlFor="peoplePreferred"
          className="select-none font-medium"
        >
          People Preffered  Medicine
        </label>
      </div>
