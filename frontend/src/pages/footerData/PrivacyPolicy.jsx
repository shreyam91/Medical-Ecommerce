...
const PrivacyPolicy = () => {
  return (
    <div className="min-h-screen ">
      ...
      <div className="space-y-6 text-gray-700 text-sm sm:text-base leading-relaxed max-w-4xl mx-auto">
        <section>
          <h2 className="text-lg sm:text-xl font-semibold text-gray-800">1. WHAT DATA DO WE COLLECT ABOUT YOU</h2>
 ...
 <li><span className='text-black font-bold'>E. Personal information: </span>Age, sex, date of birth, marital status, nationality, details of government identification documents provided, occupation, ethnicity, religion, travel history or any other personal information provided in responses to surveys or questionnaires.</li>
        ...
        <section>
          <h2 className="text-lg sm:text-xl font-semibold text-gray-800 ">2. HOW WE USE INFORMATION</h2>
          <ol className='text-gray-500'>
        ...
        <section>
          <h2 className="text-lg sm:text-xl font-semibold text-gray-800">3. COOKIES & TRACKING</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg sm:text-xl font-semibold text-gray-800 ">4. DATA SHARING</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg sm:text-xl font-semibold text-gray-800">5. SECURITY</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg sm:text-xl font-semibold text-gray-800">6. YOUR RIGHTS</h2>
          <p>
