...
function Ayurvedic() {
  ...
  const fetchProducts = async () => {
    ...
    try {
      const response = await fetch('http://localhost:3001/api/product?category=Ayurvedic')
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="flex justify-center items-center h-64">
          <div className="text-lg text-gray-600">Loading Ayurvedic products...</div>
        </div>
      </div>
    )
  }
          ...
          {filteredProducts.length > 0 ? (
            ...
            <div className="flex items-center justify-center py-16 bg-gray-50 rounded-lg border-2 border-dashed border-gray-200">
              <div className="text-center">
                ...
                <h3 className="text-xl font-medium text-gray-600 mb-2">No Ayurvedic Products Found</h3>
                <p className="text-gray-500 text-sm max-w-md mb-4">
                  We couldn't find any Ayurvedic products matching your criteria. Try adjusting your filters or search terms to discover traditional herbal remedies.
                </p>
                <button
